...
\item[Rule of thumb:\footnotemark]\footnotetext{e.g., for the exam $\ddot\smile$} There is no reason for not \emph{always} using \texttt{skimage.io.imread} (and not using \texttt{plt.imread}) except that you have to remember to load the module.
\end{description}
\begin{figure}[h!]
    \centering
    \raisebox{-0.8cm}{
